namespace Achiever.Services.Data
{
    ...
    public class AchievementsService : DefaultService<Achievement>, IAchievementsService
    {
        ...
        public IQueryable<Achievement> Get(IServicePage servicePage)
        {
            IQueryable<Achievement> entities = base.Get(servicePage);
            return entities;
        }

        //public IQueryable<Achievement> GetByThropheyId(int thropheyId, IServicePage servicePage)
        //{
        //    IQueryable<Achievement> entities = this.Get()
        //        .Where(x => x.ThropheyId == thropheyId)
        ...
        //public IQueryable<Achievement> GetByGroupId(int groupId, IServicePage servicePage)
        //{
        //    IQueryable<Achievement> entities = this.Get()
